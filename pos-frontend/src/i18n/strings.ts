...
export const es = {
  ...
  salesHistory: {
    ...
    subtitle: 'Busca una venta para ver, reenviar o cancelar su ticket.',
    dateFrom: 'Desde',
    dateTo: 'Hasta',
    apply: 'Aplicar filtros',
    loading: 'Cargando…',
    errorGeneric: 'No se pudo cargar el historial de ventas. Intenta de nuevo.',
    empty: 'No hay ventas en este rango de fechas.',
    colDate: 'Fecha',
    colCashier: 'Cajero',
    colTotal: 'Total',
    colStatus: 'Estado',
  ...
  inventory: {
    navLink: 'Inventario',
    title: 'Inventario',
    subtitle: 'Catálogo de productos, precios y lotes.',
    loading: 'Cargando…',
    errorGeneric: 'No se pudo cargar el catálogo. Intenta de nuevo.',
    ...
    saving: 'Guardando…',
    saved: 'Cambios guardados.',
    saveErrorGeneric: 'No se pudo guardar el producto. Intenta de nuevo.',
    name: 'Nombre',
    sku: 'SKU',
    ...
    requiresBatch: 'Se controla por lote (caducidad/existencias)',
    none: 'Ninguno',
    batchesTitle: 'Lotes',
    noBatchesYet: 'Todavía no tiene lotes registrados.',
